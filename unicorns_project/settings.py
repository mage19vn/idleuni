"""
Django settings for unicorns_project project.
"""
...
SECRET_KEY = 'django-insecure-ihio9x4z_&-+#4i#(yy@z3*r3yec=ogv@=*hh2+d+4!qbnc)2='
...
MIDDLEWARE = [
    ...
    'compiler.middleware.SecurityHeadersMiddleware',  # Custom security headers
]
...
WSGI_APPLICATION = 'unicorns_project.wsgi.application'
...
# Security: force Django SecurityMiddleware to set X-Content-Type-Options
